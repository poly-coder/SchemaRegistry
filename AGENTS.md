...
All content related to requirements and design is located in the `specs` folder. Read the `specs/AGENTS.md` file for instructions on how to use the agents and the structure of the `specs` folder.
